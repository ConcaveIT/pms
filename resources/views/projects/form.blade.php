				...
				<input type="hidden" name="id"  value="{{$data->id ?? "" }}" ><div class="row g-3 align-items-center">
					...
					<div class="col-md-12">
						<div class="form-group row  mb-1">
							...
							<div class="col-sm-9">
								<select class="form-control @error("client_ids") is-invalid @enderror" name="client_ids"  >
					...
					<div class="col-md-12">
						<div class="form-group row  mb-1">
							...
							<div class="col-sm-9">
								<select class="form-control @error("member_ids") is-invalid @enderror" name="member_ids"  >
									<option value="xxx">Arif::Web Developer::01711158729</option><option value="xxx">Jakaria::Web Developer::01711158729</option>
								</select>
					...
					<div class="col-md-12">
						<div class="form-group row  mb-1">
							...
							<div class="col-sm-9">
								<select class="form-control @error("project_manager_id") is-invalid @enderror" name="project_manager_id"  >
						...
						<div class="form-group row  mb-1">
							...
							<div class="col-sm-9">
								<select class="form-control @error("department_id") is-invalid @enderror" name="department_id"  >
									<option value="xxx">Web Development</option><option value="xxx">App Development</option><option value="xxx">Graphics Design</option>
								</select>
