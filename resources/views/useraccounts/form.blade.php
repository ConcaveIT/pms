...
@section('content')
	...
	<div class="card">
		<div class="card-body">
		@if(isset($data))
			<form action="{{route('useraccounts.update',$data->id)}}" method="post">
			@method('put')
		@else
		...
		@endif
			@csrf
				<div class="row g-3 align-items-center">
					...
					<div class="col-md-12">
						<div class="form-group row  mb-1">
							<label for="ModuleTitle" class="col-sm-3 col-form-label">Password<span class="text-danger">*</span>  </label>
							<div class="col-sm-9">
								<input type="text" name="password"  class="form-control @error("password") is-invalid @enderror" value="{{$data->password ?? "" }}" required>
								@error("password")
									<span class="invalid-feedback" role="alert">
										<strong>{{ $message }}</strong>
									</span>
