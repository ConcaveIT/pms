...
<script type="text/javascript" src="<?php echo  asset('assets/plugins/datatable/concave.datatables.js') ?>"></script>
<link href="<?php echo  asset('assets/plugins/datatable/concave.datatables.css') ?>" rel="stylesheet">
