		...
		@endif
			@csrf
				<div class="row g-3 align-items-center">
					...
					<div class="col-md-12">
						<div class="form-group row  mb-1">
							<label for="ModuleTitle" class="col-sm-3 col-form-label">DOB<span class="text-danger">*</span>  </label>
							<div class="col-sm-9">
					...
					<div class="col-md-12">
						<div class="form-group row  mb-1">
							<label for="ModuleTitle" class="col-sm-3 col-form-label">Salary  </label>
							<div class="col-sm-9">
					...
					<div class="col-md-12">
						<div class="form-group row  mb-1">
							<label for="ModuleTitle" class="col-sm-3 col-form-label">Marital status  </label>
							<div class="col-sm-9">
					...
					<div class="col-md-12">
						<div class="form-group row  mb-1">
							<label for="ModuleTitle" class="col-sm-3 col-form-label">Passport Number  </label>
							<div class="col-sm-9">
					...
					<div class="col-md-12">
						<div class="form-group row  mb-1">
							<label for="ModuleTitle" class="col-sm-3 col-form-label">NID Number  </label>
							<div class="col-sm-9">
					...
					<div class="col-md-12">
						<div class="form-group row  mb-1">
							<label for="ModuleTitle" class="col-sm-3 col-form-label">Emergency Contact Name<span class="text-danger">*</span>  </label>
							<div class="col-sm-9">
								<input type="text" name="emergency_contact_name"  class="form-control @error("emergency_contact_name") is-invalid @enderror" value="{{$data->emergency_contact_name ?? "" }}" required>
					...
					<div class="col-md-12">
						<div class="form-group row  mb-1">
							<label for="ModuleTitle" class="col-sm-3 col-form-label">Emergency Contact Phone<span class="text-danger">*</span>  </label>
							<div class="col-sm-9">
								<input type="text" name="emergency_contact_phone"  class="form-control @error("emergency_contact_phone") is-invalid @enderror" value="{{$data->emergency_contact_phone ?? "" }}" required>
					...
					<div class="col-md-12">
						<div class="form-group row  mb-1">
							<label for="ModuleTitle" class="col-sm-3 col-form-label">Bank A/C Number  </label>
							<div class="col-sm-9">
					...
					<div class="col-md-12">
						<div class="form-group row  mb-1">
							<label for="ModuleTitle" class="col-sm-3 col-form-label">Bank A/C Routing Number  </label>
							<div class="col-sm-9">
...
<script>
							...
							jQuery(document).ready(function(){
								jQuery("#select_designation").html("");
								var selectedVal = jQuery("#select_designation").attr("data-selected-value");
								if(jQuery("#select_designation").attr("data-select-type") == "multiple"){
									var str_array = selectedVal.split(",");
									for(var i = 0; i < str_array.length; i++) {
									str_array[i] = str_array[i].replace(/^\s*/, "").replace(/\s*$/, "");
										jQuery("#select_designation").find("option[value="+str_array[i]+"]").prop("selected", true);
									}
								}else{
									jQuery("#select_designation").find("option[value="+selectedVal+"]").prop("selected", true);
								}
							});
							...
							jQuery(document).ready(function(){
								jQuery.ajax({
									url: "{{route("database.relation.options")}}?db=salaries&key=id&display1=total_salary&display2=&display3=",
									success: function(response){
							...
							jQuery(document).ready(function(){
								jQuery("#select_merital_status").html("<option value='Married'>Married</option><option value='Unmarried'>Unmarried</option><option value='Other'>Other</option>");
