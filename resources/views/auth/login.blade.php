                ...
                <div class="row g-0">
                    <div class="col-lg-6 d-none d-lg-flex justify-content-center align-items-center rounded-lg auth-h100">
                        <div style="max-width: 25rem;">
                            ...
                            <div class="mb-5">
                                <h2 class="color-900 text-center">WorkBot - Let's Management Better</h2>
                            </div>
                            <!-- Image block -->
                            <div class="">
                        ...
                        <div class="w-100 p-3 p-md-5 card border-0 bg-dark text-light" style="max-width: 32rem;">
                            ...
                            <form class="row g-1 p-3 p-md-4" action="{{ route('login') }}" method="post">
                                ...
                                <div class="col-12 text-center mt-4">
                                    <button type="submit" class="btn btn-lg btn-block btn-light lift text-uppercase" alt="signin" >{{ __('Sign In') }}</button>
                                </div>
                                <div class="col-12 text-center mt-4">
                                    <span class="text-muted">Don't have an account yet? <a href="auth-signup.html" class="text-secondary">{{ __('Sign up here') }}</a></span>
                                </div>
                            </form>
                            <!-- End Form -->
                        </div>
