...
class ClientsController extends Controller {
	...
	function store(Request $request){
		...
		if(!$this->role->hasPermissionTo('Clients.create')){
			return response()->json("You do not have enough privileges to perform this action!", 400);
        }
	...
	function update(Request $request,$id){
		...
		if(!$this->role->hasPermissionTo('Clients.update')){
			return response()->json("You do not have enough privileges to perform this action!", 400);
        }
	...
	public function destroy($id){
		...
		if(!$this->role->hasPermissionTo('Clients.delete')){
			return response()->json("You do not have enough privileges to perform this action!", 400);
        }
