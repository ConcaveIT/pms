...
class ExpensesController extends Controller {
	...
	public function index( Request $request ){
		...
		if(!$this->role->hasPermissionTo('Expenses.view')){
	...
	function store(Request $request){
		...
		if(!$this->role->hasPermissionTo('Expenses.create')){
			return response()->json("You do not have enough privileges to perform this action!", 400);
        }
	...
	function update(Request $request,$id){
		...
		if(!$this->role->hasPermissionTo('Expenses.update')){
			return response()->json("You do not have enough privileges to perform this action!", 400);
        }
	...
	public function destroy($id){
		...
		if(!$this->role->hasPermissionTo('Expenses.delete')){
			return response()->json("You do not have enough privileges to perform this action!", 400);
        }
