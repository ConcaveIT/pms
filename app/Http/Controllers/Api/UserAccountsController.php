...
class UseraccountsController extends Controller {
	...
	public function index( Request $request ){
		...
		if(!$this->role->hasPermissionTo('UserAccounts.view')){
		...
		$results = Useraccounts::paginate(30);
	...
	function store(Request $request){
		...
		if(!$this->role->hasPermissionTo('UserAccounts.create')){
			return response()->json("You do not have enough privileges to perform this action!", 400);
        }
	...
	function update(Request $request,$id){
		...
		if(!$this->role->hasPermissionTo('UserAccounts.update')){
			return response()->json("You do not have enough privileges to perform this action!", 400);
        }
	...
	public function destroy($id){
		...
		if(!$this->role->hasPermissionTo('UserAccounts.delete')){
			return response()->json("You do not have enough privileges to perform this action!", 400);
        }
