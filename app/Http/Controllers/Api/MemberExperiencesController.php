...
class MemberexperiencesController extends Controller {
	...
	public function index( Request $request ){
		...
		if(!$this->role->hasPermissionTo('MemberExperiences.view')){
		...
		$results = Memberexperiences::paginate(30);
	...
	function store(Request $request){
		...
		if(!$this->role->hasPermissionTo('MemberExperiences.create')){
			return response()->json("You do not have enough privileges to perform this action!", 400);
        }
	...
	function update(Request $request,$id){
		...
		if(!$this->role->hasPermissionTo('MemberExperiences.update')){
			return response()->json("You do not have enough privileges to perform this action!", 400);
        }
	...
	public function destroy($id){
		...
		if(!$this->role->hasPermissionTo('MemberExperiences.delete')){
			return response()->json("You do not have enough privileges to perform this action!", 400);
        }
