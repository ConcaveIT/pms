...
class LeaverequestsController extends Controller {
	...
	public function index( Request $request ){
		...
		if(!$this->role->hasPermissionTo('LeaveRequests.view')){
		...
		$results = Leaverequests::paginate(30);
	...
	function store(Request $request){
		...
		if(!$this->role->hasPermissionTo('LeaveRequests.create')){
			return response()->json("You do not have enough privileges to perform this action!", 400);
        }
	...
	function update(Request $request,$id){
		...
		if(!$this->role->hasPermissionTo('LeaveRequests.update')){
			return response()->json("You do not have enough privileges to perform this action!", 400);
        }
	...
	public function destroy($id){
		...
		if(!$this->role->hasPermissionTo('LeaveRequests.delete')){
			return response()->json("You do not have enough privileges to perform this action!", 400);
        }
