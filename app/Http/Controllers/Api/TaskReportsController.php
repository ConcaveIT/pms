...
class TaskreportsController extends Controller {
	...
	public function index( Request $request ){
		...
		if(!$this->role->hasPermissionTo('TaskReports.view')){
		...
		$results = Taskreports::paginate(30);
	...
	function store(Request $request){
		...
		if(!$this->role->hasPermissionTo('TaskReports.create')){
			return response()->json("You do not have enough privileges to perform this action!", 400);
        }
	...
	function update(Request $request,$id){
		...
		if(!$this->role->hasPermissionTo('TaskReports.update')){
			return response()->json("You do not have enough privileges to perform this action!", 400);
        }
	...
	public function destroy($id){
		...
		if(!$this->role->hasPermissionTo('TaskReports.delete')){
			return response()->json("You do not have enough privileges to perform this action!", 400);
        }
