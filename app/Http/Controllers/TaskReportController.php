...
class TaskreportController extends Controller {
	...
	public function index( Request $request ){
		...
		if(is_null($this->user) || !$this->role->hasPermissionTo('TaskReport.view')){
		...
		$results = Taskreport::all();
		
		$info = [
			'module_name' => ucwords($this->module),
			'create_button' => 'Taskreport',
	...
	function create() {
		if(is_null($this->user) || !$this->role->hasPermissionTo('TaskReport.create')){
            return redirect()->route('dashboard')->with('error', 'You don\'t have enough privileges to perform this action!');
        }
	...
	function edit( Request $request , $id ){
		...
		if(is_null($this->user) || !$this->role->hasPermissionTo('TaskReport.update')){
            return redirect()->route('dashboard')->with('error', 'You don\'t have enough privileges to perform this action!');
        }
		$data =  Taskreport::find($id);
	...
	public function destroy($id){
		...
		if(is_null($this->user) || !$this->role->hasPermissionTo('TaskReport.delete')){
            return redirect()->route('dashboard')->with('error', 'You don\'t have enough privileges to perform this action!');
        }
