	...
	public function show($id){
		...
		return Datatables::of($data)->addIndexColumn()
					...
					->editColumn("member_id", function($row){
						$databaseRelation = '{"current_db_model":"Salary","relation_database":"members","relation_database_key":"id","relation_database_display1":"name","relation_database_display2":"designation","relation_database_display3":null}';
						return  \Helper::selectDatabaseFormat( $databaseRelation, $row->member_id);
					})
					->editColumn("status", function($row){
						$databaseRelation = '{"current_db_model":"Salary","relation_database":"statuses","relation_database_key":"id","relation_database_display1":"title","relation_database_display2":null,"relation_database_display3":null}';
