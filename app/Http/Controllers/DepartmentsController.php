...
class DepartmentsController extends Controller {
	...
	function create() {
		if(is_null($this->user) || !$this->role->hasPermissionTo('Departments.create')){
            return redirect()->route('dashboard')->with('error', 'You don\'t have enough privileges to perform this action!');
        }
	...
	function edit( Request $request , $id ){
		...
		if(is_null($this->user) || !$this->role->hasPermissionTo('Departments.update')){
            return redirect()->route('dashboard')->with('error', 'You don\'t have enough privileges to perform this action!');
        }
	...
	public function destroy($id){
		...
		if(is_null($this->user) || !$this->role->hasPermissionTo('Departments.delete')){
            return redirect()->route('dashboard')->with('error', 'You don\'t have enough privileges to perform this action!');
        }
