...
class DepartmentController extends Controller {
	...
	function edit( Request $request , $id ){
		...
		if(is_null($this->user) || !$this->role->hasPermissionTo('department.update')){
            return redirect()->route('dashboard')->with('error', 'You don\'t have enough privileges to perform this action!');
        }
	...
	public function destroy($id){
		...
		if(is_null($this->user) || !$this->role->hasPermissionTo('department.delete')){
            return redirect()->route('dashboard')->with('error', 'You don\'t have enough privileges to perform this action!');
        }
